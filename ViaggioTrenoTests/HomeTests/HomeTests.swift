...
class HomeTests: XCTestCase {
	...
	override func setUp() {
		initialState = HomeViewState(selectedStation: nil, departures: [], arrivals: [], stations: [], favouritesStations: [], train: nil, trainSections: [], origincode: nil, isRefreshing: false, followingTrainsState: TrainsViewState(trains: [], trends: [], selectedTrend: nil, error: nil, selectedTrain: nil, isFollowing: false))
